        ...
        {isMaterialComPeca ? (
          ...
          <div className="form-row form-row-2" style={{ marginTop: 10 }}>
            <div className="form-group">
              ...
              <NumInput className="form-input" min="0" step="0.01" value={novoItem.quantidade}
                onChange={v => upItem({ quantidade: v })} />
            </div>
            <div className="form-group">
              <label className="form-label">{calcArea(novoItem) > 0 ? 'PREÇO POR M² (R$)' : 'PREÇO UNITÁRIO (R$)'}</label>
              <NumInput className="form-input" min="0" step="0.01" value={novoItem.preco_unitario}
                ...
                <div className="form-row form-row-2">
                  ...
                  <div className="form-group">
                    ...
                    <NumInput
                      ...
                      step="0.01"
                      placeholder="0,00"
                      value={novoItem.preco_alternativo || 0}
                      style={{ color: 'var(--gold)', fontWeight: 700 }}
                      onChange={v => upItem({ preco_alternativo: v })}
                    />
                  </div>
                </div>
